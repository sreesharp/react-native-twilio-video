...
const {RNTwilioVideoModule} = NativeModules
...
export default class Video extends Component {
  ...
  constructor(props){
    ...
    this._eventEmitter = new NativeEventEmitter(RNTwilioVideoModule)
  }
  ...
  flipCamera(){
    RNTwilioVideoModule.flipCamera()
  }

  startCall({roomName, accessToken}) {
    RNTwilioVideoModule.startCall(accessToken,roomName)
  }

  endCall(){
    RNTwilioVideoModule.disconnect()
  }
